...
$sql = "SELECT N.news_id, N.title, CA.category, S.subcategory FROM news N, category CA, subcategory S 
        WHERE N.status='hide' AND N.category_id = CA.category_id AND N.subcategory_id = S.subcategory_id 
    ...
    <div id="wrapper">
        <div class="container-fluid">
            ...
            <div id="content" class="row p-3">
                <div id="trash_posts" class="col-12 form-border">
            ...
            <div class="modal-content">
                <form action="../backend/dashboard/controlPosts.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="submit" value="edit_trash" class="btn btn-warning">Update</button>
                    </div>
                </form>
            </div>
        </div>
